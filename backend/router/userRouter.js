...
router.put("/user/details", upload.single("photo"), async (req, res) => {
  ...
  try {
    ...
    if (file) {
      // Try to get public URL (Supabase generates this regardless of file existence)
      ...
      if (!downloadError && existingFile) {
        ...
        console.log("File already exists, reusing URL.");
        ...
        photoUrl = fileUrl.data.publicUrl;
        console.log('Uploaded new file. URL:', photoUrl);
      }
    }
